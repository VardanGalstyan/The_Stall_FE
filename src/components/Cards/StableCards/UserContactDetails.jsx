        ...
        <div className='card-user-contact-details'>
            ...
            <div className='user-contact-body'>
                <div className='user-contact-call'>
                    ...
                    <span className='user-contact-call-number'>{stable.contacts.mobile || horse.horse_owner.contacts.mobile}</span>
                </div>
                <div className='user-contact-email'>
                    <span className='user-contact-email-icon'><MdEmail /></span>
                    <span className='user-contact-email-address'>{stable.contacts.email || horse.horse_owner.contacts.email}</span>
                </div>
            </div>
