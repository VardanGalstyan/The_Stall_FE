...
function Feed() {
  ...
  const { data } = useFetch(
    `${process.env.REACT_APP_BASE_URL}/${role}/me`,
    token
  );
      ...
      <Container className="navbar-feed-container">
              ...
              <div className={`responsive-dropDown`}>
                {!token ? (
                  ...
                  <div className="responsive-dropDown-user">
                    <span
                      onClick={() =>
                        history.push(`/${role}/${data && data._id}`)
                      }>
                      My Profile
                    </span>
                    <span>Settings</span>
        ...
        {!token ? (
          <div className="navbar-feed-guest">
            ...
            <button onClick={() => setModalShow(true)} className="signUpButton">
              Sign up
            </button>
          </div>
        ) : (
          <div className="navbar-feed-elements">
            ...
            <div className={`${!show ? "d-none" : "d-block"} navbarDropDown`}>
              <div className="navbarDropDown-elements">
                <span onClick={() => history.push(`/${role}/${data._id}`)}>
                  My Profile
                </span>
                <span>Settings</span>
                <span>Help</span>
