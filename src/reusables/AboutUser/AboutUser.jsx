...
function BodyAboutUs() {
    ...
    return (
        <div className='profile-container'>
            ...
            <div className={`${isShow ? 'show-more' : 'show-less'} profile-container-aboutUs-content`}>{loremLong}</div>
            <div
                className={`${loremLong.length < 50 ? 'd-none' : 'd-block'} profile-content-aboutUs-button`}
